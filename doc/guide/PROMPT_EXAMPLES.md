...
| P009 | vi   | explain         | ready-for-agents có gọi AI API không?                                   | State static/rule-based unless configured otherwise.        |
...
| P103 | vi   | general         | viết README cho ready-for-agents bằng tiếng Việt                        | Draft README.vi.md.                                         |
